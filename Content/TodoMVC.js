...
{
 "use strict";
 var Global,PrettyTodo,Client,WebSharper,UI,Client$1,Templates,Obj,Doc,JavaScript,Pervasives,SC$1,Operators,EventTarget,Node,JS,Collections,Dictionary,DomUtility,Unchecked,RouteMap,Filter,List,T,ListModel,TodoItem,Var$1,AttrModule,Var,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,Handler,View,TodoMVC_Templates,SC$2,HashSet,Seq,WindowOrWorkerGlobalScope,SC$3,Docs,Map,Storage,Numeric,Routing,ConcreteVar,Snap,List$1,System,Guid,AttrProxy,Attrs,Array,Client$2,Event,UIEvent,Strings,DictionaryUtil,Object,Prepare,Slice,Enumerator,KeyCollection,DocElemNode,CharacterData,An,Settings,Abbrev,Mailbox,FSharpMap,ArrayStorage,Route,Fresh,HtmlModule,attr,CheckedInput,T$1,Attrs$1,Dyn,Docs$1,RunState,NodeSet,Anims,SC$4,MapUtil,AppendList,DynamicAttrNode,Elt,SC$5,Concurrency,BalancedTree,Tree,Pair,SC$6,Updates,HashSetUtil,SC$7,Easing,AsyncBody,SC$8,CT,HashSet$1,Queue,Scheduler,CancellationTokenSource,DomNodes,Error,OperationCanceledException,Lazy,SC$9,String,LazyExtensionsProxy,LazyRecord,Char,IntelliFactory,Runtime$1,console,$,Math,Date;
 Global=self;
 ...
 SC$1=Global.StartupCode$TodoMVC$Client=Global.StartupCode$TodoMVC$Client||{};
 ...
 TodoMVC_Templates=Global.TodoMVC_Templates=Global.TodoMVC_Templates||{};
 ...
 Client$2=Runtime.Client=Runtime.Client||{};
 Event=Global.Event;
 ...
 {
  var titleEditing,inp,itemDisplay,b,C,t,t$1,T$2,I,p,i;
  ...
  itemDisplay=(b=(C=Var$1.Lens(item,function(item$1)
  {
   return item$1.IsDone;
  },function(item$1,x)
  {
   return TodoItem.New(item$1.Id,item$1.Text,x,item$1.IsEditing);
  }),(t=(t$1=(T$2=View.Map(function(item$1)
  {
   return item$1.Text;
  },item.get_View()),(I=View.Map(function(st)
  {
  ...
  },item.get_View()),ProviderBuilder.Make().WithHole({
   $:2,
   $0:"itemstate",
   $1:I
  })).WithHole({
   ...
   $0:"title",
   $1:T$2
  })),t$1.WithHole(Handler.EventQ2(t$1.k,"destroy",function()
  {
   return t$1.i;
  },function()
  {
  ...
  },function()
  {
   ...
   $0:"titleediting",
   $1:inp
  }),(p=Handler.CompleteHoles(b.k,b.h,[["checked",2]]),(i=new TemplateInstance.New(p[1],TodoMVC_Templates.listitem(p[0])),(b.i=i,i)))).get_Doc();
 ...
 SC$1.$cctor=function()
 {
  var model,filterVar,todoVar,allDoneVar,notDone,allDone,b,F,b$1,C,F$1,R,R$1,p,i,T$2,t,T$3,p$1,i$1;
  ...
  function submitFn(evt)
  {
   Client.onEnter(evt,function()
   {
    ...
    text!==""?(model.Append(Client.mkTodo(text)),Var$1.Set(todoVar,"")):void 0;
   });
  }
  function selected(e)
  {
  ...
  },Client.hasAnyDoneItems(model))),(F$1=List.ofArray([Doc.Element("li",[],[Doc.Link("All",[selected(Filter.All)],function()
  {
  ...
  })])]),(R=View.Map(function(n)
  {
   return n===1?"item":"items";
  },notDone),(R$1=View.Map(Global.String,notDone),ProviderBuilder.Make().WithHole({
   $:2,
   $0:"remaining",
   $1:R$1
  })).WithHole({
   ...
   $0:"clearcompleted",
   $1:C
  })),(p=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i=new TemplateInstance.New(p[1],TodoMVC_Templates.footertemplate(p[0])),(b$1.i=i,i)))).get_Doc()),(T$2=Client.ShowIfNotEmpty(model,Doc.EmbedView(View.Map(function()
  {
  ...
  },allDone))),(t=(T$3=Client.RenderList(model,filterVar.get_View()),ProviderBuilder.Make().WithHole({
   $:8,
   $0:"newtask",
   $1:todoVar
  }).WithHole({
  ...
  },function(e)
  {
   ...
   $0:"footer",
   $1:F
  })),(p$1=Handler.CompleteHoles(b.k,b.h,[["newtask",0]]),(i$1=new TemplateInstance.New(p$1[1],TodoMVC_Templates.t(p$1[0])),(b.i=i$1,i$1)))).get_Doc()))))));
 };
 ...
 Handler.CompleteHoles=function(a,filledHoles,vars)
 {
  ...
  try
  {
   while(e.MoveNext())
    {
     h=e.Current();
     (h.$==8?($1=[h.$0,Client$2.Box(h.$1)],true):h.$==11?($1=[h.$0,Client$2.Box(h.$1)],true):h.$==10?($1=[h.$0,Client$2.Box(h.$1)],true):h.$==13?($1=[h.$0,Client$2.Box(h.$1)],true):h.$==12?($1=[h.$0,Client$2.Box(h.$1)],true):h.$==9&&($1=[h.$0,Client$2.Box(h.$1)],true))?(n=$1[0],filledVars.Add(n),allVars.set_Item(n,$1[1])):void 0;
    }
  }
  finally
  {
 ...
 TodoMVC_Templates.footertemplate=function(h)
 {
