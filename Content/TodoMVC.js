  ...
  PrettyTodo:{
   Client:{
    ...
    TodoApp:Runtime.Field(function()
    {
     ...
     return Doc.Concat([Doc.Element("section",arg101,[Doc.Element("header",[Attr.Create("class","header")],[Doc.Element("h1",[],[Doc.TextNode("todos")]),Doc.Input([Attr.Create("class","new-todo"),Attr.Handler("keyup",_submitFn_235_6),Attr.Create("placeholder","What needs to be done?"),Attr.Create("autofocus","")],_todoVar_218_1)]),Doc.Element("section",[Attr.Create("class","main")],[Doc.Element("span",[],[_ToggleAll_245_1]),Doc.Element("label",[Attr.Create("for","toggle-all")],[Doc.TextNode("Mark all as complete")]),Doc.Element("ul",[Attr.Create("class","todo-list")],[_TodoList_245_1])]),Doc.Element("div",[],[_Footer_245_1])]),Doc.Element("footer",[Attr.Create("id","info")],[])]);
    }),
